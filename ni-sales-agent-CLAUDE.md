...
```yaml
mailbox: "sales@networkintelligence.ai"      # the Outlook mailbox you watch
slack_channel: "#sales-agent"                 # where you post stagings + run summary
approval_token: "SHIP-IT"                      # human replies this in Slack to approve a HubSpot write
dry_run: true                                  # true = draft + ping only, never even create Outlook drafts
followup_cadence_days: [3, 7, 14]              # business days after PROPOSAL_SENT
max_followups: 3
business_hours_only: true
hubspot:
  pipeline: "<SET ME>"
  default_deal_stage: "<SET ME>"
  default_owner: "<SET ME>"
state_dir: "./state"
```

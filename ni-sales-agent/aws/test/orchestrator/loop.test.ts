...
function baseDeps(overrides: Partial<LoopDeps>): LoopDeps {
  ...
  return {
    ...
    judge: {
      ...
      buildProposalContent: vi.fn().mockResolvedValue({ company: 'Novelty Wealth', contactName: 'Shashank', serviceLines: ['pentest_mobile'], titleLine: 'Mobile VAPT Proposal for Novelty Wealth', understanding: ['x'], scopeRows: [{ line: 'Mobile', detail: 'A+i' }], assumptions: ['~95 screens'], approach: ['OWASP MASVS'], deliverables: ['report'], timeline: '4w', whyNi: ['CERT-In'], commercials: { mode: 'placeholder', text: 'TBC' }, nextSteps: ['NDA'], effort: { lines: [], totalManDays: 5, aiLeverageNote: '', isLarge: false }, rfp: false }),
      buildMethodologyContent: vi.fn().mockResolvedValue({ operatingLoop: [], services: [], aiHighlights: [], crosswalk: [], timeline: [], exclusions: [] }),
